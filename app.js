// npm install -g nodemon   restarts server automatically

const express = require("express"); // npm install express --save
const { open } = require("sqlite"); //npm install sqlite --save
const sqlite3 = require("sqlite3"); // npm install sqlite3 --save
...
app.post("/districts/", authenticateToken, async (request, response) => {
  ...
  VALUES
    (${stateId}, '${districtName}', ${cases}, ${cured}, ${active}, ${deaths});`; //The strings sent through the APIs must be wrapped in quotes.
...
The query parameters are used to sort/filter resources.  (request.query)
The path parameters are used to identify a specific resource(s). (request.params)
